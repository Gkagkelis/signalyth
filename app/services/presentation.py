        ...
        if not (settings.signalyth_ai_enabled and settings.openai_api_key):
            ...
            response = client.responses.create(
                ...
                instructions=(
                    ...
                    "EMOTION TERMINOLOGY LOCK (MANDATORY): when naming emotions, use ONLY the report's official "
                    "labels — Greek: Θυμός, Αποστροφή, Χαρά, Φόβος, Λύπη, Έκπληξη, Ουδέτερο · English: Anger, "
                    "Disgust, Joy, Fear, Sadness, Surprise, Neutral. NEVER synonyms (όχι «αηδία», «οργή», «απέχθεια», "
                    "«ενθουσιασμός» as labels): the charts carry these exact words and the text must match them.\n"
