...
SOURCE_CAPABILITIES = {
    "x": {
        ...
        "comment_deepening": {
            ...
            "price_per_1000_hint": None,
            "alternatives": [
                {"actor_id": "getanyapi/x-comments-scraper", "price_per_1000_hint": 0.23,
                 "note": "Same vendor family as the TikTok/Instagram comment Actors."},
            ],
    ...
    "instagram": {
        ...
        "comment_deepening": {
            "mode": "same_actor",
            "candidate_actor_id": "getanyapi/instagram-comments-scraper",
            "input_route": "comments",
            "input_field": "directUrls",
            "price_per_1000_hint": 0.27,
            "alternatives": [
                {"actor_id": "apidojo/instagram-comments-scraper", "price_per_1000_hint": 0.50,
                 "note": "API Dojo — high throughput, min 10 comments per post."},
                {"actor_id": "apify/instagram-scraper", "price_per_1000_hint": None,
                 "note": "Official Apify Actor; same Actor also covers discovery."},
            ],
            "public_schema_known": True,
            "live_verified": False,
            "enabled": False,
            "note": "Publicly listed price is indicative only; SIGNALYTH will not auto-activate before a paid smoke test.",
        },
    },
    "facebook": {
        "discovery": "primary_actor",
        "comment_deepening": {
            ...
            "price_per_1000_hint": None,
            "alternatives": [
                {"actor_id": "dami_studio/facebook-comments-scraper", "price_per_1000_hint": 0.25,
                 "input_field": "startUrls",
                 "note": "Cheap; uses startUrls — validation will confirm the field before any paid call."},
                {"actor_id": "fetch_cat/facebook-comments-scraper", "price_per_1000_hint": 0.23,
                 "input_field": "startUrls",
                 "note": "Cheapest listed; also startUrls."},
                {"actor_id": "apify/facebook-comments-scraper", "price_per_1000_hint": None,
                 "note": "Official Apify Actor; highest stability, usually pricier."},
            ],
            "public_schema_known": True,
            "live_verified": False,
            "enabled": False,
            "note": "Separate comments Actor; candidate must be independently smoke-tested and committed.",
        },
    },
    "tiktok": {
        "discovery": "primary_actor",
        "comment_deepening": {
            "mode": "companion_actor",
            "candidate_actor_id": "getanyapi/tiktok-comments-scraper",
            "input_route": "comments",
            "input_field": "startUrls",
            "price_per_1000_hint": 0.23,
            "alternatives": [
                {"actor_id": "epctex/tiktok-comment-scraper", "price_per_1000_hint": 0.30,
                 "note": "Established vendor, comments plus reply threads."},
                {"actor_id": "mu0i/tiktok-comments-scraper", "price_per_1000_hint": 0.50,
                 "note": "Explicit de-duplication — TikTok re-ranks pages and returns repeats."},
                {"actor_id": "clockworks/tiktok-comments-scraper", "price_per_1000_hint": 5.00,
                 "note": "Most popular Actor on the store, by far the most expensive."},
            ],
            "public_schema_known": True,
            "live_verified": False,
            "enabled": False,
