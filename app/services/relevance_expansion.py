...
def adaptive_expand_after_cleaning(
    ...
    # Deepening makes extra paid Actor calls and can run for many minutes once
    # comment Actors are on. Without a deadline it overruns the serverless wall;
    # without a heartbeat the run looks dead and gets resumed in parallel.
