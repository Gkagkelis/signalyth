...
def build_collection_plan(draft: AnalysisDraft) -> CollectionPlan:
    ...
    return CollectionPlan(client=draft.client,topic=draft.topic,market=draft.market,date_from=draft.date_from,date_to=draft.date_to,report_language=draft.report_language,media_handling=draft.media_handling,owned_accounts=list(draft.owned_accounts or []),
